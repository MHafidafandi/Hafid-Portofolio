      ...
      <main className="w-full flex flex-col items-center justify-center dark:text-white">
        <Layout className="pt-16">
          <AnimatedText
            ...
            className="text-center lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-0"
          />
          <div className="grid grid-cols-8 gap-16 mt-16 sm:gap-8 ">
            ...
            <div className="col-span-3 relative h-max rounded-2xl bg-white p-8 border border-solid border-black dark:bg-black dark:border-white xl:col-span-4 md:order-1 md:col-span-8 ">
            ...
            <div className="col-span-2 flex flex-col items-end justify-between xl:flex-row xl:col-span-8 xl:items-center md:order-3">
